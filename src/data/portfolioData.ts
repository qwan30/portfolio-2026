...
export const portfolioData = {
  ...
  projects: [
    ...
    },
    {
      ...
      gallery: [
        { url: "/hospital-screens/graph-rag-detail.png", title: "Đồ thị Tri thức Bệnh nhân & Graph RAG Multi-Hop Traversal", badge: "Graph RAG Engine" },
        { url: "/hospital-screens/13-chat-patient.png", title: "AI Chat Lâm sàng Trích dẫn Bằng chứng & SSE Streaming", badge: "Clinical AI Chat" },
        { url: "/hospital-screens/27-citations-compare.png", title: "Cổng Đối chiếu & Xác thực Nguồn Trích dẫn Chống Ảo giác", badge: "Citation Gate" },
        { url: "/hospital-screens/07-patient-timeline.png", title: "Dòng Thời gian Lịch sử Bệnh lý Đa chiều (Patient Timeline)", badge: "EMR Timeline" },
        { url: "/hospital-screens/20-documents-ocr-queue.png", title: "Hàng đợi OCR & Vector Indexing Bất đồng bộ (Redis/RQ)", badge: "Async Ingestion" },
        { url: "/hospital-screens/21-audit-log.png", title: "Nhật ký Kiểm toán Truy vết Fail-Closed Chuẩn HIPAA", badge: "Fail-Closed Audit" },
        { url: "/hospital-screens/08-patient-medications.png", title: "Cảnh báo Lâm sàng Tương tác Thuốc & Dị ứng (CDSS Agent)", badge: "CDSS Safety Agent" },
        { url: "/hospital-screens/06-patient-overview.png", title: "Hồ sơ Tổng quan Bệnh nhân Tích hợp Cầu nối HMS Sync", badge: "HMS EMR Sync" },
        { url: "/hospital-screens/02-dashboard.png", title: "Bảng Điều khiển Giám sát Vận hành & Phân tích Thời gian Tiết kiệm", badge: "Impact Analytics" },
        { url: "/hospital-screens/29-access-requests.png", title: "Quy trình Yêu cầu Cấp quyền Truy cập Hồ sơ Bệnh án Đặc biệt", badge: "RBAC/ABAC Gate" }
      ],
      overview: {
